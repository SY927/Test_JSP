...
public class GuguTest3 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<tr align=center bgcolor='#E0E0F8'>");
		out.print("<td colspan = 4>" + dan + "단 출력 </td>");
		out.print("</tr>");
		
		for (int i = 0; i < 10; i++) {
			if (i%2 == 0) {
				out.print("<tr align = center bgcolor = '#FBF5EF'>");
			} else {
				out.print("<tr align = center bgcolor = '#EFF5FB'>");
			}
			out.print("<td width = 200>");
			out.print("<input type = 'radio' name = 'rdo' >" + i);
			out.print("</td>");
			out.print("<td width = 200>");
