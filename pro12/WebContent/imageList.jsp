...
<style type = "text/css">
.lst_type {overflow:hidden; widht:80%; padding:0 10px 10px; margin:0 auto}
...
border-bottom:2px solod lightgray; position:relative;}
.lst_type li mg{display:inline; float:left; position:absolute;}
